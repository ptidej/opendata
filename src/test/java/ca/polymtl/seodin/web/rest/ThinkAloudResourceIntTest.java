...
import ca.polymtl.seodin.repository.ThinkAloudRepository;
import ca.polymtl.seodin.repository.search.ThinkAloudSearchRepository;
...
public class ThinkAloudResourceIntTest {
    ...
    public void setup() {
        ...
        ThinkAloudResource thinkAloudResource = new ThinkAloudResource(thinkAloudRepository, thinkAloudSearchRepository);
    ...
    public void createThinkAloud() throws Exception {
        ...
        assertThat(testThinkAloud.getRegistred()).isEqualTo(DEFAULT_REGISTRED);

        // Validate the ThinkAloud in Elasticsearch
        ThinkAloud thinkAloudEs = thinkAloudSearchRepository.findOne(testThinkAloud.getId());
        assertThat(thinkAloudEs).isEqualToComparingFieldByField(testThinkAloud);
    }
    ...
    public void updateThinkAloud() throws Exception {
        ...
        assertThat(testThinkAloud.getRegistred()).isEqualTo(UPDATED_REGISTRED);
