...
import ca.polymtl.seodin.repository.DefectRepository;
import ca.polymtl.seodin.repository.search.DefectSearchRepository;
...
public class DefectResourceIntTest {
    ...
    public void setup() {
        ...
        DefectResource defectResource = new DefectResource(defectRepository, defectSearchRepository);
    ...
    public void createDefect() throws Exception {
        ...
        assertThat(defectEs).isEqualToComparingFieldByField(testDefect);
    }
