...
import ca.polymtl.seodin.repository.SoftwareSystemRepository;
import ca.polymtl.seodin.repository.search.SoftwareSystemSearchRepository;
...
public class SoftwareSystemResourceIntTest {
    ...
    public void setup() {
        ...
        SoftwareSystemResource softwareSystemResource = new SoftwareSystemResource(softwareSystemRepository, softwareSystemSearchRepository);
    ...
    public void createSoftwareSystem() throws Exception {
        ...
        assertThat(softwareSystemEs).isEqualToComparingFieldByField(testSoftwareSystem);
    }
