...
import ca.polymtl.seodin.repository.ScriptRepository;
import ca.polymtl.seodin.repository.search.ScriptSearchRepository;
...
public class ScriptResourceIntTest {
    ...
    public void setup() {
        ...
        ScriptResource scriptResource = new ScriptResource(scriptRepository, scriptSearchRepository);
