...
import ca.polymtl.seodin.repository.DeveloperRepository;
import ca.polymtl.seodin.repository.search.DeveloperSearchRepository;
...
public class DeveloperResourceIntTest {
    ...
    public void setup() {
        ...
        DeveloperResource developerResource = new DeveloperResource(developerRepository, developerSearchRepository);
